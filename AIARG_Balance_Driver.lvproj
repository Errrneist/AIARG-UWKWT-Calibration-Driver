	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				<Item Name="ULx Clear Task.vi" Type="VI" URL="/&lt;userlib&gt;/ULx/Task.llb/ULx Clear Task.vi"/>
				<Item Name="ULx Create Virtual Channel.vi" Type="VI" URL="/&lt;userlib&gt;/ULx/Create Channel.llb/ULx Create Virtual Channel.vi"/>
				<Item Name="ULx Read (Analog 1D Wfm NChan 1Samp).vi" Type="VI" URL="/&lt;userlib&gt;/ULx/Read.llb/ULx Read (Analog 1D Wfm NChan 1Samp).vi"/>
				<Item Name="ULx Start Task.vi" Type="VI" URL="/&lt;userlib&gt;/ULx/Task.llb/ULx Start Task.vi"/>
				<Item Name="ULx Timing (Sample Clock).vi" Type="VI" URL="/&lt;userlib&gt;/ULx/Timing.llb/ULx Timing (Sample Clock).vi"/>
			</Item>
			...
			<Item Name="ULx_LV.dll" Type="Document" URL="/C/Program Files (x86)/National Instruments/LabVIEW 8.5/vi.lib/ULx/ULx_LV.dll"/>
		</Item>
